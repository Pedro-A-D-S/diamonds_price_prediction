...
# diamond_price_prediction documentation build
...
from diamond_price_prediction import __version__ as release
...
htmlhelp_basename = "diamond_price_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "diamond_price_prediction.tex",
        "diamond_price_prediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "diamond_price_prediction",
        "Project diamond_price_prediction codebase.",
        "Data-Science",
    )
]
